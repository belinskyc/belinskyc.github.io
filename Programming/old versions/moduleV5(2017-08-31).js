...
- switch code block from <addr> to <h6>
  - D2L allows <addr> to be embedded within <addr> but doe snot allow this with <h6>
...
function createInPageLinks()
{
	...
	for(i=0; i<linkElements.length; i++)	
	{
		...
		else if(linkElements[i].innerText.trim() != "") // there is content but an invalid link -- add warnng to text
		{
